...
export default function Udlejning(props) {
    return (
        <>
            <header className="bg-dark py-5 bg-img" style={{ backgroundImage: `url(${background})`, backgroundPosition: `top center` }}>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        ...
                        <div className="text-center mt-4">
                            <Link className="btn btn-success btn-lg px-4" to="/udlejning/shelter">Start booking</Link>
                        </div>
                    </div>
                </div>
            </div>
